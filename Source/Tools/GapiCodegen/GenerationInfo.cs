...
namespace GtkSharp.Generation {
	...
	public class GenerationInfo {
		...
		public StreamWriter OpenStream (string name, string namespce)
		{
			...
			//
			// This pragma is NOT made redundant by the <auto-generated/> marker
			// above: that marker silences Roslyn *analysers*, and CS0612/CS0618
			// are compiler warnings, which it does not touch.
		...
		/// <summary>
		/// Writes the header every generated C# file starts with.
		/// </summary>
		/// <remarks>
		/// The first line has to be exactly "// &lt;auto-generated /&gt;", and it
		/// has to be first: Roslyn decides a file is generated by looking at the
		/// leading comment, and skips analyser diagnostics for it. That is what
		/// keeps analyser noise out of two thousand files nobody can edit.
		///
		/// It does NOT suppress compiler warnings, and it does NOT exclude
		/// anything from code coverage -- coverlet has never read it. Coverage
		/// exclusion is configured in
		/// Source/Tests/GtkSharp.Tests/coverlet.runsettings; see Docs/coverage.md.
		/// </remarks>
		static void WriteCSharpHeader (StreamWriter sw)
		{
