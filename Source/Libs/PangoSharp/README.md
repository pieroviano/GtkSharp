...
C# bindings for **Pango** and **PangoCairo** — text layout, shaping, fonts and attributes.

Use this rather than Cairo's toy text API for anything a user reads.

## What it binds

Native library: `libpango-1.0` and `libpangocairo-1.0`

Depends on: GLibSharp, CairoSharp
