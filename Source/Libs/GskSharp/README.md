...
C# bindings for **Gsk** — Gtk 4's rendering layer: render nodes, transforms, renderers and paths.

Gtk 4 draws through a retained scene graph rather than by handing you a Cairo context, and this is that graph.

## What it binds

Native library: `libgtk-4` (Gsk is part of it)

Depends on: GLibSharp, GioSharp, CairoSharp, PangoSharp, GrapheneSharp, GdkSharp
