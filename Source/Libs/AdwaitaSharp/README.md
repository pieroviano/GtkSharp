...
C# bindings for **libadwaita** — GNOME's adaptive widgets and platform styling: navigation views, toasts, banners, preference pages and the style manager.

## What it binds

Native library: `libadwaita-1`
